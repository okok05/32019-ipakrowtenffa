					...
					<form class="form-horizontal" method="POST" action="IU_Server_Post.php">
					    ...
					    <fieldset class="content-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="form-group">
										<label class="control-label col-lg-2">Is Installed</label>
										<div class="checkbox checkbox-switchery col-lg-10">
											<input type="checkbox" class="switchery" name="chkIsInstalled" id="chkIsInstalled" <?php if($isInstalled_Server==1) echo 'checked';?>>
										</div>
									</div>
								...
								<div class="text-right">
									<button type="submit" name="submit" class="btn btn-primary"><?php echo $buttonText;?><i class="icon-arrow-right14 position-right"></i></button>
								
									<button type="submit" formaction="csv.php" class="btn btn-success"><?php echo $buttonText1;?><i class="success"></i></button>
								</div>
