...
if($id_Server>0){
    ...
    $cmd = "/etc/init.d/iptables save";     //test
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    ...
    //Create config files
    $url = 'http://80.241.209.193/exactarget/PMTA/build_pmta_config.php';
    ...
    $cmd = "echo 'export VISUAL=\"nano\"' >> ~/.bash_profile";      //test
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "echo 'export EDITOR=\"nano\"' >> ~/.bash_profile";      //test
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br> \n");
    ...
    $cmd = "yum -y install perl-ExtUtils-MakeMaker";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    ...
    $cmd = "yum -y install php-pecl-ssh2";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    ...
    $cmd = "wget http://repo.mysql.com/mysql-community-release-el7-5.noarch.rpm";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "rpm -ivh mysql-community-release-el7-5.noarch.rpm";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "yum -y install mysql mysql-devel mysql-server mod_auth_mysql"; //test
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    ...
    $cmd = "wget -N -P /etc http://80.241.209.193/etc/sudoers";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "wget -N -P /etc http://80.241.209.193/etc/php.ini";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    ...
    $cmd = "wget -N -P /var/www http://80.241.209.193/slive/r.zip";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "unzip -o /var/www/r -d /var/www";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    ...
    $cmd = "/bin/systemctl restart httpd.service";      //error
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    ...
    $cmd = "/bin/systemctl restart crond.service";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "/bin/systemctl restart postfix.service";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "/bin/systemctl restart sendmail.service";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
