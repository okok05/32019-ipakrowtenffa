...
if($id_Server>0){
    ...
    $cmd = "wget -P /root http://45.56.93.78/pmta/PowerMTA-4.0r6-201204021809.x86_64.rpm";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "wget -N -P /etc http://45.56.93.78/httpd/sudoers";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "wget -N -P /etc http://45.56.93.78/httpd/php.ini";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "wget -N -P /etc/httpd/conf http://45.56.93.78/httpd/httpd.conf";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    ...
    $cmd = "wget -P /etc/pmta http://45.56.93.78/pmta/license";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
    
    $cmd = "wget -P /etc/pmta http://45.56.93.78/pmta/license.linux64";
    echo $rsp = my_ssh2($connection, $cmd);
    ob_flush();
    flush();
    fwrite($logfile, $rsp."<br>\n");
