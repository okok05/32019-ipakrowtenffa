					    ...
					    <div class="panel-body">
							...
							?>
									<tr>
										...
										<a class="btn border-teal text-teal btn-flat btn-rounded btn-icon btn-xs valign-text-bottom btnInstall" id="<?php echo $row["id_Server"];?>" os="<?php echo $row["name_OS"];?>" title="Install" <?php echo $isInstalled_Server ?>><i class="icon-hammer-wrench"></i>
										</a>
										</a>
										<a  class="btn border-danger-400 text-danger-400 btn-flat btn-rounded btn-icon btn-xs valign-text-bottom btnBuildConfig" id="<?php echo $row["id_Server"];?>" title="Replace Domain"><i class="icon-hammer-wrench"></i>
                                        </a>
...
<script>
    ...
    $('.btnInstall').click(function()
	{
        ...
        var os          =   $(this).attr('os');
        window.location = 'http://45.56.93.78/exactarget/Server/ServerInstall_'+os+'.php?id='+id_server;
	...
	//$('.btnBuildConfig').click(function(e)
	{
		...
		$.post
		(
			'../PMTA/build_pmta_config_Domain.php',
			{'id_server':id_server},
			function(result)
			{
				alert(result);
