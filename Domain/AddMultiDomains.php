		...
		<?php Include('../Includes/sidebar.php');?>
			...
			<div class="content-wrapper">
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Multi Domain</span> - <?php echo $buttonText;?></h4>
						</div>
				...
				<div class="content">
					...
					<form class="form-horizontal" method="POST" action="MultiDomains_Post.php">
					    ...
					    <fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<textarea class="form-control" name="txtDomainName" id="txtDomainName" cols="10" rows="10" value="<?php echo $name_Domain;?>"></textarea>
										</div>
									</div>
