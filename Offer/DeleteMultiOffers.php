	...
	<div class="page-container">
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Offers</span> - Delete Multi Offers</h4>
						</div>
				...
				<div class="content">
					...
					<form class="form-horizontal" method="POST" action="">
					    ...
					    <fieldset class="content-group">
							<legend class="text-bold">Delete Multi Offers</legend>

							<div class="form-group">
								<label class="control-label col-lg-2">Offers</label>
								<div class="col-lg-10">
       ...
       if(isset($_POST['submit']))
      {
	   ...
	   foreach ($textAr as $line) {
		...
		$lines = trim($line);
		$requete   = $bdd->prepare('delete from offer where sid_Offer = ?');
		$requete->execute(array(trim( $lines )));
		
		
		}
		echo "<script>alert('All Offers Deleted');</script>";
   }
