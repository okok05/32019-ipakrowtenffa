<?php
   ...
   else
   {
	  ...
	  $requete->execute(array(NULL,$name_Offer,$id_Sponsor_Offer,$countrys,$isActive_Offer,$isSensitive_Offer,$link_Offer,$unsub_Offer,$suppression,$notWorkingDays,$id_Vertical_Offer,'md5',$sid_Offer));
