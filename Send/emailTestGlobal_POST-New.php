<?php
 ...
 //exit;
	...
	foreach($tab_ips as $ip)
	{
		...
		$requete = $bdd->prepare('select d.name_Domain,s.alias_Server from domain d , ip i , server s where i.IP_IP = ? and i.id_Domain_IP = d.id_Domain and i.id_Server_IP = s.id_Server');
