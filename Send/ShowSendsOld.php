					...
					<div class="panel panel-flat">
					    <div class="panel-body">
							...
							<?php
							    ...
							    $requete = $bdd->prepare("select o.name_Offer, i.name_isp, s.* from send s , offer o , isp i where s.id_Offer_Send = o.id_Offer and s.id_ISP_Send = i.id_Isp and s.id_Employer_Send=? order by s.id_Send desc");
