...
$('.btnSend').click(function(){
   ...
   $.post('RealSend-New.php',{id_Send:idSend,fraction:Fraction,seed:Seed,xDelay:xDelay},function(data){
      alert(data);
...
$('.btnTestSend').click(function(){
   ...
   $.post('SendTestOutSide-New.php',{id_Send:idSend},function(data){
      alert(data);
   });
...
$('#cmbIsps').change(function(){
		   ...
		   {
			   var idIsp = $(this).val();
			   $.post('ajax.php',{type:'ispCopy',id_Isp:idIsp},function(data){
				  $('#tableData').html(data);
				  $('#tableData').show();
			   });
		   }
