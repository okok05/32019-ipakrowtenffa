	...
	<div class="page-container">
		...
		<?php Include('../Includes/sidebar.php');?>
			...
			<div class="content-wrapper">
				...
				<!-- Auto Response -->	
				<?php if(  ($_SESSION['id_Employer']==0)  or  ($_SESSION['id_Employer']==53)  or ($_SESSION['id_Employer']==57)  or($_SESSION['id_Employer']==54)or($_SESSION['id_Employer']==58)or($_SESSION['id_Employer']==61or  ($_SESSION['id_Employer']==68))   ):?>	
					<!-- Extra -->
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-flat">
